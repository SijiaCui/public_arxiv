...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \vspace{-\intextsep}
    \includegraphics[width=0.48\textwidth]{figures/v-march-intro-final.pdf}
...
% VLM 的进展和挑战
Vision-Language Models (VLMs) have demonstrated remarkable capabilities across a wide range of multimodal tasks, from image captioning to visual question answering (VQA)~\cite{achiam2023gpt,touvron2023llama,liu2023llava,chen2024internvl,bai2025qwen3,comanici2025gemini}. 
...
~\cite{shao2024deepseekmath,wen2025reinforcement,yu2026dapo,yue2026does}.
...
The first relies on human annotations or external supervision, such as curated factual datasets, preference annotations, or learned reward models~\cite{bai2022constitutional,ouyang2022training}.
...
\begin{wrapfigure}{l}{0.5\textwidth}
    \centering
    \vspace{-\intextsep}
    \includegraphics[width=0.48\textwidth]{figures/v-march-motivation-final.pdf}
...
\begin{itemize}
    ...
    \item Comprehensive ablation studies and analyses provide insights into the design of effective self-verification mechanisms for VLMs.
\end{itemize}
