...
We evaluate \ours on 12 benchmarks spanning hallucination evaluation (+3.30), real-world visual question answering (+1.74), and general multimodal understanding benchmarks (+4.07), where it consistently outperforms existing methods without human-annotated factual supervision.
...
\input{sections/3-preliminary.tex}
\input{sections/4-method-vcr.tex}
